          ...
          <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl shadow-lg w-[900px] max-w-[95vw] p-6 relative">
              ...
              <div className="space-y-3">
                ...
                {/* Dracula-like code editor for system prompt */}
                <div className="rounded-lg border" style={{ borderColor: '#44475a' }}>
                  <div className="grid" style={{ gridTemplateColumns: '3rem 1fr' }}>
                    ...
                    <div
                      ...
                      onWheel={(e)=>{
                        if (promptTextAreaRef.current) {
                          ...
                          if (lineNumberInnerRef.current) {
                            lineNumberInnerRef.current.style.transform = `translateY(-${ta.scrollTop}px)`;
                          }
                          e.preventDefault();
                        }
                      }}
                    ...
                    >
                      <div
                        ref={lineNumberInnerRef}
                        className="m-0 text-right text-xs font-mono"
                        style={{ padding: '12px 8px', lineHeight: `${lineHeight}px` }}
                      >
                    ...
                    <div className="relative" style={{ background: '#282a36' }}>
                      <textarea
                        ...
                        onScroll={(e)=>{
                          if (lineNumberInnerRef.current) {
                            lineNumberInnerRef.current.style.transform = `translateY(-${e.currentTarget.scrollTop}px)`;
                          }
                        }}
                        spellCheck={false}
                        className="w-full h-[420px] block font-mono text-sm resize-none"
                        style={{
