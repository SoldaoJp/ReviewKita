    ...
    <div className="p-4 max-w-[1800px] mx-auto">
      ...
      <div className="grid grid-cols-12 gap-2">
        ...
        <div className="col-span-12 lg:col-span-8 flex flex-col justify-between">
          ...
          <div className="grid grid-cols-2 gap-2 mt-2">
            <button className="w-full bg-white rounded-xl p-4 card-shadow font-medium hover:bg-gray-50 transition text-gray-700 flex items-center justify-center gap-2">
