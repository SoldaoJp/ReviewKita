    ...
    <div className="min-h-screen flex flex-col items-center bg-gradient-to-b from-blue-50 to-blue-100 text-gray-800 font-sans py-8">
      ...
      <div className="w-full max-w-md flex flex-col items-center space-y-5">
        <input
          ...
          disabled={showFeedback}
          className={`w-full px-4 py-3 rounded-lg border-2 focus:outline-none focus:ring-2 font-medium ${
            showFeedback
              ? isCorrect
      ...
      {showFeedback && (
        <div className="w-full max-w-2xl px-6 mt-8">
          <div className={`w-full rounded-xl border-2 shadow-lg p-4 ${
            isCorrect 
            ...
            {!isCorrect && (
              <div className="text-center mb-3">
                <p className="text-sm text-red-700">
                  <strong>Correct answer:</strong> {question.identification_answer}
                </p>
              </div>
            )}
