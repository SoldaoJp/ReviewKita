        ...
        <div className="w-full max-w-md md:max-w-xl p-8 md:p-10 rounded-2xl glass-card shadow-lg bg-white/70 backdrop-blur">
          ...
          <form className="space-y-4">
            ...
            <input
              ...
              className="w-full rounded-md px-4 py-3 bg-white/40 border border-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-300 backdrop-blur"
